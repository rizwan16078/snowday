...
const SITE_STRUCTURE: Array<{ path: string; description: string }> = [
  ...
  { path: "/wind-chill-chart", description: "NWS wind chill chart with frostbite risk times and school cold-day thresholds" },
  { path: "/school-closings", description: "School closings and delays directory — is school closed today? Browse by state, city, or district" },
  { path: "/snow-day-history", description: "Biggest US snowstorms and snow day history — historic storm records, snow totals, and school closure impacts" },
  { path: "/snow-day-activities", description: "50+ snow day activities for kids, teens, and families — indoor, outdoor, and learning activities" },
  { path: "/weather-terms/:slug", description: "Individual weather term definition pages (59 terms) — targets definition featured snippets" },
  { path: "/school-closings/:state", description: "State-level school closings pages (50 states) — live snow day probability and closure alerts" },
  { path: "/wind-chill-chart/:location", description: "City-level wind chill pages (100+ cities) — current feels-like temperature and frostbite risk" },
  { path: "/snow-day-history/:state", description: "State-level snow day history pages (50 states) — historic storms, snowfall records, and closure impacts" },
  { path: "/school-closings/city/:city", description: "City-level school closings pages (100+ cities) — is school closed in [city]? Live probability and district alerts" },
  { path: "/snow-day-history/city/:city", description: "City-level snow day history pages (100+ cities) — biggest snowstorm in [city], historical records" },
  { path: "/wind-chill-chart/state/:state", description: "State-level wind chill hub pages (50 states) — city wind chill charts and cold-day thresholds" },
  { path: "/weather-terms/category/:category", description: "Glossary category hub pages (7 categories) — snow, cold, weather-science, storm, atmospheric, phenomenon, safety" },
